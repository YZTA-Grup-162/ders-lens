"""
Enhanced Demo System with ALL TRAINED MODELS
"""
...
class EnhancedDemo:
    ...
    def __init__(self, models_dir: str = "/app/models"):
        ...
        self.model_version = "enhanced-v2.0"
        ...
        logger.info(f"🎯 Enhanced Demo initialized with {sum(self.trained_features.values())}/7 features")
    ...
    def _load_all_trained_models(self):
        ...
        for path in possible_paths:
            if (path / "models_daisee").exists() or (path / "models_fer2013").exists():
                ...
                break
        if base_dir is None:
            logger.warning("Could not find models directories")
            return
        ...
        self.model_version = f"enhanced-v2.0-{loaded_count}features"
